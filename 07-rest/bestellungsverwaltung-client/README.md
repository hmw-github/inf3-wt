...
Sie können die Datei `bestellungen.html` direkt im Browser öffnen oder über einen Webserver bereitstellen. Gegebenenfalls muss die URL (Pfad, Port) in `bestellungen.js` angepasst werden.
